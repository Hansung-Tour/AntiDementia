...
class Question12Fragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_question12, container, false) //fragment_question 수정
    }
    ...
    override fun onClick(v: View?) {
        when(v?.id) { //0==오답, 1==정답, score[Number] Number가 0인 경우 1번문제
            ...
            R.id.op3->{score[3] = 0}
            R.id.next->{navController.navigate(R.id.action_question12Fragment_to_question13Fragment)}
        }
    }
}
